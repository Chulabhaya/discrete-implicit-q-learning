...
def parse_args():
    ...
    parser.add_argument("--dataset-path", type=str, default="/home/chulabhaya/phd/research/datasets/keydoor_7x7/pomdp/9-29-23_pomdp_keydoor_7x7_100_percent_random_data_size_100000.pkl",
...
if __name__ == "__main__":
    ...
    vf1 = RecurrentDiscreteValueGridVerseObs(env).to(device)
